...
router.get('/credit-intelligence', (0, requirePermission_1.requirePermission)('reports.view'), (req, res, next) => controller.getCreditIntelligence(req, res, next));
router.post('/credit-intelligence/query', (0, requirePermission_1.requirePermission)('reports.view'), (req, res, next) => controller.queryCreditIntelligence(req, res, next));
router.post('/credit-intelligence/auto-reminders', (0, requirePermission_1.requirePermission)('reports.view'), (req, res, next) => controller.runAutoCreditReminders(req, res, next));
