...
router.get('/inventory-intelligence', requireOwner_1.requireOwner, (req, res, next) => controller.getInventoryStockIntelligence(req, res, next));
router.post('/inventory-intelligence/query', requireOwner_1.requireOwner, (req, res, next) => controller.queryInventoryStockIntelligence(req, res, next));
router.post('/natural-language', requireOwner_1.requireOwner, (req, res, next) => controller.getNaturalLanguageReport(req, res, next));
