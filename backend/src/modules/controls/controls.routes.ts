...
router.post('/stock/variances', requireOwner, (req, res, next) => controller.recordStockVariance(req, res, next));
...
router.post('/stock/count-sessions', requireOwner, (req, res, next) => controller.startStockCountSession(req, res, next));
...
router.post('/stock/count-sessions/:id/items', requireOwner, (req, res, next) => controller.recordStockCountItem(req, res, next));
router.post('/stock/count-sessions/:id/submit', requireOwner, (req, res, next) => controller.submitStockCountSession(req, res, next));
...
router.put('/stock/location-balances', requireOwner, (req, res, next) => controller.setLocationBalance(req, res, next));
router.get('/stock/location-balances', (req, res, next) => controller.getLocationBalances(req, res, next));
router.post('/stock/transfers', requireOwner, (req, res, next) => controller.transferStock(req, res, next));
router.get('/stock/transfers', (req, res, next) => controller.listStockTransfers(req, res, next));
router.post('/stock/supplier-deliveries', requireOwner, (req, res, next) => controller.recordSupplierDelivery(req, res, next));
...
router.get('/risk-fraud', requireOwner, (req, res, next) => controller.getRiskFraudInsights(req, res, next));
router.post('/risk-fraud/query', requireOwner, (req, res, next) => controller.queryRiskFraudInsights(req, res, next));
router.post('/communications/daily-owner-summary', requireOwner, (req, res, next) => controller.dispatchDailyOwnerSummary(req, res, next));
router.post('/communications/credit-reminders', requireOwner, (req, res, next) => controller.dispatchCreditRepaymentReminders(req, res, next));
router.post('/communications/supplier-reorder', requireOwner, (req, res, next) => controller.dispatchSupplierReorderDrafts(req, res, next));
router.post('/communications/critical-risk-alerts', requireOwner, (req, res, next) => controller.dispatchCriticalRiskAlerts(req, res, next));
